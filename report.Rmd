...
## Airthmatic Cumulative Returns
```{r, echo=FALSE}
y.range<-range(CPNY.acum[,1])
plot(CPNY.acum, type="l",auto.grid=FALSE,xlab="Date",ylab="Airthmatic Cumulative Returns", ylim=y.range,minor.ticks=FALSE, main=tick)
```

## Logarithmic Cumulative Returns
```{r, echo=FALSE}
y.range<-range(CPNY.logcum[,1])
plot(CPNY.logcum, type="l",auto.grid=FALSE,xlab="Date",ylab="Logarithmic Cumulative Returns", ylim=y.range,minor.ticks=FALSE, main=tick)
```
